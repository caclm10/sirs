...
@section('content')
    ...
    <h3 class="mb-3">Tambah Predikat Sikap</h3>

    <x-success-alert />

    <form action="{{ route('dashboard.admin.predikat-sikap.store') }}" method="POST">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea name="deskripsi_spiritual" id="deskripsi_spiritual"
                class="form-control @error('deskripsi_spiritual') is-invalid @enderror">{{ old('deskripsi_spiritual') }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea name="deskripsi_sosial" id="deskripsi_sosial"
                class="form-control @error('deskripsi_sosial') is-invalid @enderror">{{ old('deskripsi_sosial') }}</textarea>
